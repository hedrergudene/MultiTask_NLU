...
# NER
def F1_NER(ner_model_output, ner_ground_truth, idxs2tag, original_idxs):
    ...
    input = np.vectorize(convert_tags)(input, original_idxs)
    ...
    target = np.vectorize(convert_tags)(target, original_idxs)
    # Metrics
